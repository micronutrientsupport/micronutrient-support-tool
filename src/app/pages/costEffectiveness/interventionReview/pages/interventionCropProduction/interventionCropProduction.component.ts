...
@Component({
  selector: 'app-intervention-crop-production',
  templateUrl: './interventionCropProduction.component.html',
  styleUrls: ['./interventionCropProduction.component.scss'],
})
export class InterventionCropProductionComponent implements OnInit {
