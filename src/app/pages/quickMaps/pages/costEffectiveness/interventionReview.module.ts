...
import { InterventionReviewFooterComponent } from './interventionReview/utilities/reusableInterventionReviewFooter/reusableInterventionReviewFooter.component';
...
@NgModule({
  declarations: [
    ...
    InterventionReviewFooterComponent,
  ],
  imports: [
    CommonModule,
