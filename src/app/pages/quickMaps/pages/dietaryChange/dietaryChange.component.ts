...
@Component({
  selector: 'app-dietary-change',
  templateUrl: './dietaryChange.component.html',
  styleUrls: ['./dietaryChange.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DietaryChangeComponent implements OnInit {
  ...
  private dataLevelWidgetTypesMap: Map<DataLevel, Array<GridsterWidgets>> = new Map([
    [DataLevel.COUNTRY, [this.WIDGETS.DIET_CHANGE_COMPARISON]],
    [DataLevel.HOUSEHOLD, [this.WIDGETS.DIET_CHANGE_COMPARISON]],
  ]);
