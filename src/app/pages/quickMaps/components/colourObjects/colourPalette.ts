...
export class ColourPalette {
  ...
  private static getPalette(id: string, paletteType: string): ColourPalette {
    ...
    return null != retievedObject ? new ColourPalette(retievedObject.name, retievedObject.coloursArray) : null;
  }
  ...
  public generateColors(count: number): Array<string> {
    ...
    return chroma.scale(this.colourHexArray).colors(count) as Array<string>;
  }
  /**
