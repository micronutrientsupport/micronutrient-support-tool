...
export abstract class CacheableEndpoint<RETURN_TYPE, PARAMS_TYPE, OBJECT_TYPE = RETURN_TYPE>
  extends Endpoint<RETURN_TYPE, PARAMS_TYPE, OBJECT_TYPE> {
  ...
  public call(params?: PARAMS_TYPE, useCache?: boolean): Promise<RETURN_TYPE> {
    ...
    if ((null != cacheValue) && useCache) {
      ...
      this.currentCallPromise = super.call(params)
        .then((value: RETURN_TYPE) => {
          // set to cache
