...
export class InterventionFarmerAdoption extends BaseObject implements Named {
  ...
  public readonly farmerAdoption: FarmerAdoption | unknown;

  protected constructor(sourceObject?: Record<string, unknown>) {
    super(sourceObject);

    this.interventionId = this._getNumber(InterventionFarmerAdoption.KEYS.INTERVENTION_ID);
    this.farmerAdoption = this._getValue(InterventionFarmerAdoption.KEYS.FARMER_ADOPTION);
  }
}

export interface FarmerAdoption {
  adoptionRateLocal: AdoptionLevel;
  adoptionRateHybrid: AdoptionLevel;
  adoptionRateRecycled: AdoptionLevel;
}
